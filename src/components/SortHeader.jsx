export default function SortHeader({ col, label, sortBy, sortDir, sortToggle, align = "right" }) {
  ...
  return (
    <th className={`px-2 py-2 text-${align} text-[10px] uppercase tracking-wider font-medium text-text-3 hover:text-text cursor-pointer select-none`} onClick={() => sortToggle(col)}>
